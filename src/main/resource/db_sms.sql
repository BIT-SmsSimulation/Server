/**
 * SQL DDL file for smsSimulation server.
 * 
...
CREATE USER sms_admin IDENTIFIED BY '*qqe#CytWfiP3TsTx0M';
GRANT INSERT,SELECT,UPDATE,CREATE,DELETE,DROP ON db_sms.* TO sms_admin;
